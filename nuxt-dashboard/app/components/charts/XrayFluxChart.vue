<template>
  <div class="panel sub-panel">
    <div class="flex justify-between items-start mb-4">
      <div>
        <h2 class="text-secondary font-bold uppercase tracking-wider text-sm">GOES X-ray Flux</h2>
        <p class="text-[#c8c6ca] text-[10px] mt-1 font-mono uppercase">Log Scale | 24H</p>
      </div>
    </div>

    <div class="relative flex-1">
      <div class="absolute left-0 top-0 bottom-6 flex flex-col justify-between items-end pr-2 z-10 w-8 h-full">
        <span class="text-[#ef4444] text-[10px] font-bold absolute right-2" style="bottom: 83.33%;">X</span>
        <span class="text-orange-500 text-[10px] font-bold absolute right-2" style="bottom: 66.66%;">M</span>
        <span class="text-yellow-500 text-[10px] font-bold absolute right-2" style="bottom: 50%;">C</span>
        <span class="text-[#7e7d7f] text-[10px] font-mono absolute right-2" style="bottom: 33.33%;">B</span>
        <span class="text-[#7e7d7f] text-[10px] font-mono absolute right-2" style="bottom: 16.66%;">A</span>
      </div>
