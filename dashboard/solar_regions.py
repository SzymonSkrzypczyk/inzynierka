...
def render(limit: Optional[int] = None):
    ...
    if 'area' in df.columns and 'observed_date' in df.columns:
        ...
        add_download_button(area_ts, "ewolucja_powierzchni_regionow", "Download chart data as CSV")
    ...
    if 'observed_date' in df.columns:
        ...
        add_download_button(counts, "statystyka_regionow_slonecznych", "Download chart data as CSV")
